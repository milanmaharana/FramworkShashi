...
public class BaseClass {
	...
	public PropertyUtility pf=new PropertyUtility();
	...
	public void beforesuiteBS() {
		System.out.println("Data Base Connection and Initialization Or log Reprots");
		}
	
	@BeforeTest(groups = {"Smoke","Integration","Regration"})
	public void beforTestBT() {
	...
	public void beforeClassBC(/*@Optional("chrome") String browser*/) throws Exception {
		...
		String browser=pf.getPropertiesFileData("browser");
		String url=pf.getPropertiesFileData("url");
	...
	public void beforeMethodBM() throws Exception {
		...
		String user=pf.getPropertiesFileData("user");
		String pass=pf.getPropertiesFileData("pass");
