...
public class CreateLeadScenarioOneTest extends BaseClass {
	...
	public void createLeads() throws Exception {
		...
		cnlp.getPhoneNumber().sendKeys(excel.getExcelCellData("Organization", 1, 2));
		cnlp.getMobileNumber().sendKeys(excel.getExcelCellData("Organization", 2, 2));
