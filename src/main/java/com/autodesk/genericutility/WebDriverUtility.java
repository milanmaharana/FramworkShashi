...
public class WebDriverUtility {
	...
	/**
	 * This method give you browser, from which browser you want to execute?
	 * @param driver
	 * @param browser
	 */
	public void SelectBrowserExecution(WebDriver driver,String browser) {
	...
	/**
	 * This Method helps to Switch to PopUp Winodw
	 * @param driver
	 */
	...
	public void executeJavaScript(WebDriver driver , String javaScript) {
	   ...
	   public void waitAndClick(WebElement element) throws InterruptedException
	   {
	    ...
	    public String takeScreenshot(WebDriver driver, String screenshotName) throws Throwable {
	    	screenshotName=screenshotName+new JavaUtility().getCurrentDate().toString(); 
